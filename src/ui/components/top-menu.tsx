      ...
      return (
          ...
          <header className="topmenu">
            <ul>
                ...
                <li className="d-none d-md-inline"><Link className={this.props.current === "mech-creator" ? "current" : "" } to={`${process.env.PUBLIC_URL}/classic-battletech/mech-creator`}>'Mech Creator</Link></li>
            ...
            <div className="mobile-menu">
                <ul className="styleless">
                    ...
                    <li><Link onClick={this.closeMobile} className={this.props.current === "mech-creator" ? "current" : "" } to={`${process.env.PUBLIC_URL}/classic-battletech/mech-creator`}>'Mech Creator</Link></li>
